...
ヘッダーからバグ報告、新機能提案、非公開の脆弱性報告を開ける。
...
\begin{itemize}
  ...
  \item \textbf{最低定員・最高定員} ── 1チームあたりの参加人数の範囲（MyIDバーコード読み取りによる参加本登録確認に利用する）
\end{itemize}
...
昼休みに行われる特別競技（昼競技）を複数セッション単位で設定・進行管理する。テンプレートから競技を作成すると大会競技へ自動連携される。
...
大会当日に複数の昼競技を行う場合も、競技ごとに独立したセッションとして登録できる。
