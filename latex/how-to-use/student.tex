...
\begin{itemize}
  ...
  \item \textbf{student} ── 本書が対象とする基本権限。エントリー・観戦・通知受信のみ。
\end{itemize}

\subsection*{クラス代表について}

初回ログイン時にクラスを選択すると、\code{クラス名\_rep} 形式のロールが自動的に付与される。
このロールにより、自クラスのチーム編成管理など、追加の操作が利用できる。
...
\subsection{メッセージのやり取り}

申請ごとにチャット形式でrootとメッセージのやり取りができる。
内容の確認や追加情報の提供に利用する。
