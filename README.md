...
独自タイピングシステムは単体で動作し、6チームの確定得点と順位をJSONでSportEaseへ取り込みます。仕様は、[共通仕様の範囲](./docs/typing_system_core_scope.md)、[確定結果JSON仕様](./docs/typing_system_results_json_spec.md)、[参加チーム構成JSON](./docs/typing-team-structure-v1.json)、[運営・試合状況機能仕様](./docs/typing_system_operations_spec.md)、[スコア計算仕様](./docs/typing_system_scoring_spec.md)、[入力判定仕様](./docs/typing_system_input_spec.md)、[問題・問題セット仕様](./docs/typing_system_problem_spec.md)を参照してください。
