...
| `backapp/internal/middleware/auth.go` | `session_token` Cookie、Redisセッション、`AuthMiddleware`、`RoleRequired`、クラス代表権限 |
...
| --- | --- | --- | --- | --- |
| イベント管理 | `frontapp/src/routes/dashboard/root/event-management/` | `event_handler.go` | `event_repository.go`, `event.go` | `backapp/tests/handler/event_handler_test.go`, `backapp/tests/repository/event_repository_test.go`, `frontapp/tests/e2e/root-event-management.spec.js` |
| 競技管理 | `frontapp/src/routes/dashboard/root/sport-management/`, `frontapp/src/routes/dashboard/admin/sport-details-registration/`, `frontapp/src/routes/dashboard/student/sport-info/` | `sport_handler.go`, `image_handler.go`, `pdf_handler.go` | `sport_repository.go`, `sport.go` | `backapp/tests/handler/sport_handler_test.go`, `backapp/tests/repository/sport_repository_test.go`, `frontapp/tests/e2e/root-sport-management.spec.js` |
...
| クラス・チーム管理 | `frontapp/src/routes/dashboard/admin/class-management/`, `frontapp/src/routes/dashboard/student/class-info/` | `class_handler.go`, `class_team_handler.go` | `class_repository.go`, `team_repository.go`, `class.go`, `team.go` | `backapp/tests/handler/class_handler_test.go`, `backapp/tests/handler/class_team_handler_test.go`, `backapp/tests/repository/class_repository_test.go`, `backapp/tests/repository/team_repository_test.go` |
...
| 通知配信 | `frontapp/src/routes/dashboard/root/notification/`, `frontapp/src/routes/dashboard/student/notification/`, `frontapp/src/lib/components/NotificationSettings.svelte` | `notification_handler.go`, `push_subscription.go` | `notification_repository.go`, `notification.go` | `backapp/tests/handler/notification_handler_test.go`, `frontapp/tests/e2e/root-notification.spec.js` |
...
| PWA/Push購読 | `frontapp/src/service-worker.js`, `frontapp/src/lib/utils/push.js`, `frontapp/src/lib/stores/pushSubscriptionStore.js`, `frontapp/src/lib/components/PWANotificationBanner.svelte` | `notification_handler.go` | `notification_repository.go` | `NOTIFICATION_TROUBLESHOOTING.md`, `frontapp/tests/unit/lib/components/NotificationSettings.svelte.spec.js` |
...
3. バックエンドは `notification_handler.go` と `notification_repository.go` を見る。
